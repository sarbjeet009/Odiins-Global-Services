...
<body style="background-color: var(--bg-light-blue);">
  ...
  <div id="adminAuthOverlay" class="admin-auth-container">
    <div class="admin-auth-card">
      <div style="display:flex; justify-content:center; margin-bottom:1.25rem;">
        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/icons/logo.svg'); ?>" alt="Odiins Logo" height="52">
      </div>
        ...
        <div class="ad-platform-card social-card-insta">
          <div style="display:flex; justify-content:space-between; align-items:flex-start; flex-wrap:wrap; gap:0.5rem;">
            <div>
              <div style="display:flex; align-items:center; gap:0.5rem;">
                ...
                <h3 style="font-size:1.2rem; color:var(--text-charcoal);">Instagram Official Channel</h3>
              </div>
              <p style="font-size:0.85rem; color:var(--text-muted);" id="instaHandle">@odiins.odisha</p>
            </div>
            <div style="display:flex; gap:0.5rem;">
              <a href="https://www.instagram.com/odiins.odisha" target="_blank" class="btn btn-white btn-sm">🔗 Open Profile</a>
              <button class="btn btn-white btn-sm" onclick="openSocialModal('instagram')">⚙️ Connect Meta API</button>
            </div>
          </div>
          ...
          <div style="display:grid; grid-template-columns:repeat(auto-fit, minmax(140px, 1fr)); gap:1rem; margin:1.25rem 0;">
            <div style="background:var(--bg-light-blue); padding:0.9rem; border-radius:var(--radius-md);">
              ...
              <div style="font-size:1.15rem; font-weight:800; color:#E1306C;" id="instaFollowers">Registered</div>
              <div style="font-size:0.7rem; color:var(--text-muted);">Official Handle</div>
            </div>
            <div style="background:var(--bg-light-blue); padding:0.9rem; border-radius:var(--radius-md);">
              <div style="font-size:0.75rem; color:var(--text-muted); font-weight:700;">API TELEMETRY</div>
              <div style="font-size:1.15rem; font-weight:800; color:var(--text-charcoal);" id="instaPosts">Ready to Sync</div>
              <div style="font-size:0.7rem; color:var(--text-muted);">Awaiting Graph Token</div>
            </div>
            <div style="background:var(--bg-light-blue); padding:0.9rem; border-radius:var(--radius-md);">
              <div style="font-size:0.75rem; color:var(--text-muted); font-weight:700;">DIRECT WHATSAPP</div>
              <div style="font-size:1.15rem; font-weight:800; color:var(--primary-green);">Active</div>
              <div style="font-size:0.7rem; color:var(--text-muted);">Bio Link Firing</div>
            </div>
            <div style="background:var(--bg-light-blue); padding:0.9rem; border-radius:var(--radius-md);">
          ...
          <div style="background:#F8FAFC; border:1px solid var(--border-light); border-radius:var(--radius-md); padding:1rem;">
            <h4 style="font-size:0.95rem; margin-bottom:0.35rem;">ℹ️ Instagram Automated Telemetry Connection</h4>
            <p style="font-size:0.82rem; color:var(--text-muted); margin-bottom:0.75rem;">
              To display real-time follower counts, reel views, and comments directly in this dashboard, click <strong>"Connect Meta API"</strong> above and supply your Meta Graph API User Token.
            </p>
          </div>
        </div>
        ...
        <div class="ad-platform-card social-card-yt">
          <div style="display:flex; justify-content:space-between; align-items:flex-start; flex-wrap:wrap; gap:0.5rem;">
            <div>
              ...
              <p style="font-size:0.85rem; color:var(--text-muted);" id="ytChannel">Odiins - Odisha Jobs &amp; Manpower (@OdiinsOdisha)</p>
            </div>
            <div style="display:flex; gap:0.5rem;">
              <a href="https://www.youtube.com/@OdiinsOdisha" target="_blank" class="btn btn-white btn-sm">🔗 Open YouTube</a>
              <button class="btn btn-white btn-sm" onclick="openSocialModal('youtube')">⚙️ Connect YouTube API</button>
            </div>
          </div>
          ...
          <div style="display:grid; grid-template-columns:repeat(auto-fit, minmax(140px, 1fr)); gap:1rem; margin:1.25rem 0;">
            <div style="background:var(--bg-light-blue); padding:0.9rem; border-radius:var(--radius-md);">
              <div style="font-size:0.75rem; color:var(--text-muted); font-weight:700;">CHANNEL STATUS</div>
              <div style="font-size:1.15rem; font-weight:800; color:#FF0000;" id="ytSubs">Registered</div>
              <div style="font-size:0.7rem; color:var(--text-muted);">Official Handle</div>
            </div>
            <div style="background:var(--bg-light-blue); padding:0.9rem; border-radius:var(--radius-md);">
              <div style="font-size:0.75rem; color:var(--text-muted); font-weight:700;">API TELEMETRY</div>
              <div style="font-size:1.15rem; font-weight:800; color:var(--text-charcoal);" id="ytVideos">Ready to Sync</div>
              <div style="font-size:0.7rem; color:var(--text-muted);">Awaiting Cloud Key</div>
            </div>
            <div style="background:var(--bg-light-blue); padding:0.9rem; border-radius:var(--radius-md);">
              <div style="font-size:0.75rem; color:var(--text-muted); font-weight:700;">VIDEO GUIDES</div>
              <div style="font-size:1.15rem; font-weight:800; color:#0369A1;">Career &amp; Staffing</div>
              <div style="font-size:0.7rem; color:var(--text-muted);">Ready for upload</div>
            </div>
            <div style="background:var(--bg-light-blue); padding:0.9rem; border-radius:var(--radius-md);">
              <div style="font-size:0.75rem; color:var(--text-muted); font-weight:700;">GOOGLE TAG</div>
              <div style="font-size:1.15rem; font-weight:800; color:var(--primary-green);">AW-11452908312</div>
              <div style="font-size:0.7rem; color:var(--primary-green);">Active on Website</div>
            </div>
          </div>

          <div style="background:#F8FAFC; border:1px solid var(--border-light); border-radius:var(--radius-md); padding:1rem;">
            <h4 style="font-size:0.95rem; margin-bottom:0.35rem;">ℹ️ YouTube Data API v3 Telemetry Connection</h4>
            <p style="font-size:0.82rem; color:var(--text-muted); margin-bottom:0.75rem;">
              To sync live subscriber counts and video telemetry from YouTube into your executive command center, click <strong>"Connect YouTube API"</strong> above and supply your Google Cloud API key.
            </p>
          </div>
        </div>
  ...
  <script>
    ...
    function renderSocialTab() {
      ...
      if (ig) {
        document.getElementById('instaHandle').textContent = ig.handle || '@odiins.odisha';
        document.getElementById('instaFollowers').textContent = ig.connected ? ig.followers : 'Registered';
        document.getElementById('instaPosts').textContent = ig.connected ? ig.totalPostsAndReels : 'Ready to Sync';
      }

      const yt = socialData.youtube;
      if (yt) {
        document.getElementById('ytChannel').textContent = `${yt.channelName} (${yt.channelHandle})`;
        document.getElementById('ytSubs').textContent = yt.connected ? yt.subscribers : 'Registered';
        document.getElementById('ytVideos').textContent = yt.connected ? yt.totalVideos : 'Ready to Sync';
      }
    }
