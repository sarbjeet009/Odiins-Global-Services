...
<body style="background-color: var(--bg-light-blue);">
    ...
    <div class="dash-panel" id="panelAds">
      <div class="ads-grid-3">
        ...
        <div class="ad-platform-card meta-theme">
          ...
          <div class="ad-metric-val" id="adMetaLeadsCount" style="color:#0081FB;">39</div>
          <div style="font-size:0.85rem; color:var(--text-muted);">Verified Leads (Form: <strong>CSP Form 01</strong>)</div>
          <div style="margin-top:0.75rem; padding-top:0.5rem; border-top:1px solid var(--border-light); font-size:0.78rem; display:flex; justify-content:space-between; flex-wrap:wrap; gap:0.25rem;">
            ...
            <span>Avg CPL: <strong id="adMetaLiveCpl" style="color:#15803D;">₹7.11 / lead</strong></span>
      ...
      <div style="background:var(--bg-white); padding:1.75rem; border-radius:var(--radius-lg); box-shadow:var(--card-shadow); border:1px solid var(--border-light); margin-bottom:1.5rem;">
        <div style="display:flex; justify-content:space-between; align-items:center; flex-wrap:wrap; gap:0.5rem; margin-bottom:1rem;">
          <div>
            <h3 style="font-size:1.25rem; margin-bottom:0.2rem;">⚡ Live Meta Ad Campaigns &amp; Leads Acquired (act_1060505796783425)</h3>
            <p style="font-size:0.85rem; color:var(--text-muted);">Directly connected: Odiins Meta Ad Account &bull; Business Portfolio ID: 1412272150853565 &bull; Instant Form: <strong>CSP Form 01</strong></p>
          </div>
          <div style="display:flex; gap:0.5rem; align-items:center; flex-wrap:wrap;">
            <a href="https://business.facebook.com/latest/leads_center" target="_blank" class="btn btn-outline-primary btn-sm" style="font-size:0.8rem; display:inline-flex; align-items:center; gap:0.35rem; text-decoration:none;">
              📥 Download Leads (CSV/Excel) ↗
            </a>
            <span class="milestone-badge-pill" style="background:#DCFCE7; color:#15803D;">● 39 Total Leads</span>
          </div>
        </div>

        <!-- Meta Ads Manager Insight & Verification Guide Banner -->
        <div style="background:#EFF6FF; border:1px solid #BFDBFE; border-radius:var(--radius-md); padding:1rem 1.25rem; margin-bottom:1.25rem; font-size:0.85rem; color:#1E40AF; line-height:1.5;">
          <div style="display:flex; align-items:flex-start; gap:0.6rem;">
            <span style="font-size:1.25rem;">💡</span>
            <div>
              <strong>Why leads don't show by default in Meta Ads Manager:</strong>
              In Meta Ads Manager (<a href="https://adsmanager.facebook.com" target="_blank" style="color:#1D4ED8; font-weight:600;">adsmanager.facebook.com</a>), the view defaults to <em>"Performance"</em> which only shows link clicks.
              To display your 39 leads inside Meta Ads Manager: click <strong>Columns: Performance</strong> &gt; select <strong>Customize Columns</strong> &gt; search &amp; check <strong>Leads (Total)</strong> &gt; click <strong>Apply</strong>.
              To download applicant names &amp; phone numbers, go to <strong>Meta Business Suite &gt; All Tools &gt; Instant Forms</strong>.
            </div>
          </div>
        </div>
          ...
          <table class="leads-table">
            ...
            <tbody id="metaCampaignsTableBody">
              <tr>
                ...
                <td><span class="milestone-badge-pill" style="background:#DCFCE7; color:#15803D; font-weight:800; font-size:0.85rem;">22 Leads</span></td>
                <td><strong style="color:#15803D;">₹8.47</strong> / lead</td>
                <td>₹186.39</td>
                <td>58</td>
              </tr>
              <tr>
                ...
                <td><span class="badge-lead-type badge-ad-meta">Lead Generation</span></td>
                <td><span class="milestone-badge-pill" style="background:#DCFCE7; color:#15803D;">● ACTIVE</span></td>
                <td><span class="milestone-badge-pill" style="background:#DCFCE7; color:#15803D; font-weight:800; font-size:0.85rem;">13 Leads</span></td>
                <td><strong style="color:#15803D;">₹5.18</strong> / lead</td>
                <td>₹67.36</td>
                <td>17</td>
              </tr>
              <tr>
                ...
                <td><span class="badge-lead-type badge-ad-meta">Lead Generation</span></td>
                <td><span class="milestone-badge-pill" style="background:#DCFCE7; color:#15803D;">● ACTIVE</span></td>
                <td><span class="milestone-badge-pill" style="background:#DCFCE7; color:#15803D; font-weight:800; font-size:0.85rem;">2 Leads</span></td>
                <td><strong style="color:#15803D;">₹3.91</strong> / lead</td>
                <td>₹7.82</td>
                <td>6</td>
              </tr>
              <tr>
            ...
            <tfoot>
              <tr style="background:#F8FAFC; font-weight:700;">
                <td colspan="3"><strong>Total Active Meta Lead Campaigns</strong></td>
                <td><span class="milestone-badge-pill" style="background:#DCFCE7; color:#15803D; font-weight:800; font-size:0.85rem;">37 Active Leads (39 All-time)</span></td>
                <td><strong style="color:#15803D;">₹7.11 Blended CPL</strong></td>
                <td>₹277.45 Total</td>
                <td>167 Clicks</td>
              </tr>
            </tfoot>
  ...
  <script>
    ...
    // 3.5 Ad Settings & Live Meta Ads Fetch
    let adSettingsData = null;
    ...
    function renderAdSettings() {
      if (!adSettingsData || !adSettingsData.meta) return;
      const meta = adSettingsData.meta;
      const metrics = meta.metrics || {};

      const leadsCount = metrics.leads !== undefined ? metrics.leads : 39;
      const elLeads = document.getElementById('adMetaLeadsCount');
      if (elLeads) elLeads.textContent = leadsCount;

      if (metrics.spend !== undefined) {
        const elSpend = document.getElementById('adMetaLiveSpend');
        if (elSpend) elSpend.textContent = '₹' + metrics.spend;
        const inputMeta = document.getElementById('inputMetaSpend');
        if (inputMeta) inputMeta.value = metrics.spend;
      }
      if (metrics.cpl !== undefined) {
        const elCpl = document.getElementById('adMetaLiveCpl');
        if (elCpl) elCpl.textContent = `₹${metrics.cpl} / lead`;
      }
      if (metrics.impressions !== undefined) {
        const elImp = document.getElementById('adMetaImpressions');
        if (elImp) elImp.textContent = Number(metrics.impressions).toLocaleString('en-IN');
      }
      if (metrics.clicks !== undefined) {
        const elClicks = document.getElementById('adMetaClicks');
        if (elClicks) elClicks.textContent = `${metrics.clicks} (CPC ₹${metrics.cpc || '1.66'})`;
      }

      if (Array.isArray(meta.campaigns) && meta.campaigns.length) {
        const tbody = document.getElementById('metaCampaignsTableBody');
        if (tbody) {
          tbody.innerHTML = meta.campaigns.map(c => {
            const isActive = c.status === 'ACTIVE';
            const statusBadge = isActive
              ? `<span class="milestone-badge-pill" style="background:#DCFCE7; color:#15803D;">● ACTIVE</span>`
              : `<span class="milestone-badge-pill" style="background:#F1F5F9; color:#64748B;">PAUSED</span>`;
            const leadsBadge = (c.leads > 0)
              ? `<span class="milestone-badge-pill" style="background:#DCFCE7; color:#15803D; font-weight:800; font-size:0.85rem;">${c.leads} Leads</span>`
              : `<span style="color:var(--text-muted);">${c.leads || 0}</span>`;
            const cplVal = (c.leads > 0 && c.cpl)
              ? `<strong style="color:#15803D;">₹${c.cpl}</strong> / lead`
              : `<span style="color:var(--text-muted);">--</span>`;
            const spendVal = c.spend ? `₹${c.spend}` : '--';
            const clicksVal = c.clicks !== undefined ? c.clicks : '--';
            const objBadge = c.objective === 'OUTCOME_LEADS'
              ? `<span class="badge-lead-type badge-ad-meta">Lead Generation</span>`
              : `<span class="badge-lead-type badge-ad-organic">Link Clicks</span>`;
    ...
    function updateAdsTabMetrics() {
      ...
      let metaCount = (adSettingsData && adSettingsData.meta && adSettingsData.meta.metrics && adSettingsData.meta.metrics.leads) || 39;
      const organicCount = allLeads.length - allLeads.filter(l => (l.adSource || '').includes('Google') || (l.adSource || '').includes('Meta')).length;
    ...
    function calculateCpl() {
      ...
      const metaCount = (adSettingsData && adSettingsData.meta && adSettingsData.meta.metrics && adSettingsData.meta.metrics.leads) || 39;

      const gSpend = parseFloat(document.getElementById('inputGoogleSpend').value) || 0;
      const mSpend = parseFloat(document.getElementById('inputMetaSpend').value) || 277.45;

      const gCpl = Math.round(gSpend / googleCount);
      const mCpl = (mSpend / metaCount).toFixed(2);
      const totalPaidLeads = (allLeads.filter(l => (l.adSource || '').includes('Google')).length + metaCount) || 1;
      const blendedCpl = ( (gSpend + mSpend) / totalPaidLeads ).toFixed(2);
