    ...
    <div class="container">
      <div class="footer-grid">
        ...
        <div class="footer-col">
          <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/icons/logo.svg'); ?>" alt="Odiins Logo" height="42" style="filter: brightness(0) invert(1); margin-bottom: 1rem;">
          <p>
