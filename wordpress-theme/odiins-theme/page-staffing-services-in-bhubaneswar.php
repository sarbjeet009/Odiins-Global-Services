<?php
/**
 * Template Name: Odiins - Staffing & Manpower Solutions in Bhubaneswar
 */
get_header();
?>
  ...
  <section class="landing-hero" id="employerFormSection">
    <div class="container landing-grid">
      ...
      <div class="hero-content">
        ...
        <h1 class="hero-headline">Staffing and Manpower Solutions in Bhubaneswar — From Ground Staff to Sales Managers</h1>
